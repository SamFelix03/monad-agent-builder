...
export function AgentWalletModal({ open, onOpenChange, variant = "default" }: AgentWalletModalProps) {
  ...
  const [tokenBalances, setTokenBalances] = useState<{ mon: string } | null>(null)
  ...
  const displayBalance = tokenBalances?.mon || "0.00"
        ...
        >
          {hasWallet ? (
            <>
              ...
              <span className="font-semibold">{displayBalance} MON</span>
            </>
          ) : (
            <>
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <code className="surface-row flex-1 break-all p-3.5 font-mono text-sm">
                    {dbUser.wallet_address}
                  </code>
