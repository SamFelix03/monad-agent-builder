...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold transition-spring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          'bg-primary text-primary-foreground shadow-sm hover:scale-[1.02] active:scale-[0.98] hover:bg-primary/90',
        destructive:
        ...
        outline:
          'border border-border/70 bg-card/60 shadow-xs hover:bg-accent/80 hover:text-accent-foreground hover:scale-[1.02] active:scale-[0.98] dark:bg-input/30 dark:border-input dark:hover:bg-input/50',
        secondary:
        ...
        brand:
          'bg-brand-gradient text-white shadow-md hover:scale-[1.03] active:scale-[0.97] hover:shadow-lg',
      },
      size: {
